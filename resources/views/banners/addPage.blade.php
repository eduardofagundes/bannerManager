        ...
        <form action="{{ route('banner.create') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col d-flex justify-content-between align-items-center">
                    ...
                    <input type="string" class="form-control" name="banner_imgage_width" id="banner_imgage_width" required>
                    <label for="banner_image_heigth">Altura: </label>
                    <input type="string" class="form-control" name="banner_image_heigth" id="banner_image_heigth" required>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-2">
                ...
                <div class="col">
                    <input type="string" class="form-control" name="banner_alt" id="banner_alt">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-2">
                ...
                <div class="col">
                    <input type="string" class="form-control" name="banner_top_text" id="banner_top_text">
                </div>
            </div>
            ...
            <div class="text-muted border-bottom mb-3">Preços e filtros</div><div class="form-group row">
                ...
                <div class="col">
                    ...
                    <input type="date" class="form-control" name="banner_begin" id="banner_begin">
                    <label for="banner_end">fim</label>
                    <input type="date" class="form-control" name="banner_end" id="banner_end">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col">
                    <select class="form-control" name="banner_price_model" id="banner_price_model">
            ...
            <div class="form-group row">
                ...
                <div class="col">
                    <input type="string" class="form-control" name="banner_price" id="banner_price" required>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-2">
                ...
                <div class="col">
                    <input type="string" class="form-control" name="banner_impressions_limit" id="banner_impressions_limit">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-2">
                ...
                <div class="col">
                    <input type="string" class="form-control" name="banner_clicks_limit" id="banner_clicks_limit">
                </div>
            </div>
